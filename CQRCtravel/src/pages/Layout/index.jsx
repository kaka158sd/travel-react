...
const Layout = () => {
  ...
  // 点击用户头像事件
  const handleUserItems = (path) => {
    setText('用户中心');
    navigate(`/touristCenter${path}`);
  };
    ...
    items: [
      {
        ...
        icon: (
          <i
            className="iconfont icon-user text-color1"
            style={{ fontSize: 16 }}
          />
        ),
      ...
      },
      {
        ...
        icon: (
          <i
            className="iconfont icon-guanli text-color1"
            style={{ fontSize: 16 }}
          />
        ),
        onClick: () => handleUserItems('/setting'),
      },
      {
        key: 'helpCenter',
        label: '帮助中心',
        icon: (
          <i
            className="iconfont icon-help text-color1"
            style={{ fontSize: 16 }}
          />
        ),
        onClick: () => handleUserItems('/helpCenter'),
      },
      {
        key: 'logout',
        label: '退出登录',
        icon: (
          <i
            className="iconfont icon-shut-down text-color1"
            style={{ fontSize: 16 }}
          />
        ),
